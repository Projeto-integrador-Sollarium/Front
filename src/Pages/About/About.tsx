                    ...
                    <div className="justify-center py-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
                            <div className='container mx-auto my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-center'>
                                <div>
                                    <img src="https://i.pinimg.com/564x/50/27/39/502739bf7c30221ef504e364907b2b23.jpg" alt="Camilla" className="rounded-full w-24 h-24 mx-auto mb-2"/>
                                    <h3>Camilla</h3>
                                </div>
                                <div>
                                    <img src="https://i.pinimg.com/736x/72/d6/4c/72d64c72c2edc52b5d7b5ead0cb724a2.jpg" alt="Giovanna" className="rounded-full w-24 h-24 mx-auto mb-2"/>
                                    <h3>Giovanna</h3>
                                </div>
                                <div>
                                    <img src="https://i.pinimg.com/564x/b5/9a/70/b59a708051f23cebb9debaa0e7ac716d.jpg" alt="Pedro" className="rounded-full w-24 h-24 mx-auto mb-2"/>
                                    <h3>Pedro</h3>
                                </div>
                                <div>
                                    <img src="https://i.pinimg.com/564x/c7/b5/91/c7b59165af56d1490216649f089907e0.jpg" alt="Thais" className="rounded-full w-24 h-24 mx-auto mb-2"/>
                                    <h3>Thais</h3>
                                </div>
                                <div>
                                    <img src="https://i.pinimg.com/736x/05/22/91/0522916c52a9f92a59663d60b9198618.jpg" alt="Vinicius" className="rounded-full w-24 h-24 mx-auto mb-2"/>
                                    <h3>Vinicius</h3>
                                </div>
                            </div>
                        </div>
