...
function Navbar() {
  ...
  <div className="container flex items-center justify-between text-lg">
    <div className="flex items-center gap-2">
      ...
      <div className='text-2xl font-bold uppercase text-gray-800'>Sollarium</div>
    </div>

    <div className='flex gap-6'>
      <Link to='/home' className='bg-cyan-50 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l'>Home</Link>
      <Link to='/register' className='bg-cyan-50 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l'>Cadastro</Link>
